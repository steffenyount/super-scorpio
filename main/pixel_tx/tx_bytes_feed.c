...
// dma_gpio_tx_bytes_feed:  ->
void __not_in_flash_func(init_dma_gpio_tx_bytes_feed)() {
    ...
    channel_config_set_ring(&dma_channel_ctrl, true, PWM_SLICE_TX_BYTES_ALIGN_SIZE_BITS);
...
//    dma_channel_set_read_addr(DMA_TX_BYTES_FEED_CHAN, &tx_enabled[0][0], false);
    dma_channel_set_write_addr(DMA_TX_BYTES_FEED_CHAN, pwm_slice_tx_bytes, false);
